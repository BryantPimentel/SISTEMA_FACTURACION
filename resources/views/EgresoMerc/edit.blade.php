    ...
    <div class="col-md-12">
        ...
        <div class="card bg-white">
            ...
            <div class="card-header bg-white">
                <h5 class="card-title text-black">Editar Mercaderia #{{ $egreso_cab->id }}</h5>
            ...
            <div class="card-body">
                ...
                <form method="POST" class="needs-validation"
                    action="{{ url('/egreso_mercaderia/' . $egreso_cab->id) }}" novalidate>

                    {{ method_field('PATCH') }}
                    {{ csrf_field() }}

                    @include ('EgresoMerc.form', ['formMode' => 'edit'])
